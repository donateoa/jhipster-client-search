...
export class EntityFilterComponent implements OnInit {
  ...
  @Output()
  changeList: EventEmitter<IEntityFilter[]> =
      new EventEmitter<IEntityFilter[]>();
  @Input()
  ...
  get entity(): any { return this._entity; }
  constructor() {}
  ...
  changed() { this.changeList.emit(this.filterList); }
}
